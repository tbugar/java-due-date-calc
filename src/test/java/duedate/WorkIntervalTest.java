...
public class WorkIntervalTest {
    ...
    private final Calendar startDate = new GregorianCalendar(2019, Calendar.NOVEMBER, 28, 10, 12);
    private final Calendar startDateZeroMinutes = new GregorianCalendar(2019, Calendar.NOVEMBER, 28, 10, 0);
    ...
    public void testAddHoursThroughDay() {
        ...
        Assert.assertEquals(29, workInterval.getDueDate().get(Calendar.DAY_OF_MONTH));
    }
    ...
    public void testAddHoursInDay() {
        ...
        Assert.assertEquals(28, workInterval.getDueDate().get(Calendar.DAY_OF_MONTH));
    }
    ...
    public void testAddHoursUntilEndHourWithZeroMinutes() {
        ...
        Assert.assertEquals(28, workIntervalZeroMinutes.getDueDate().get(Calendar.DAY_OF_MONTH));
    }
}
